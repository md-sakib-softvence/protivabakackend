...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('BOOKING_NEW', 'BOOKING_ACCEPTED', 'BOOKING_REJECTED', 'BOOKING_COMPLETED', 'BOOKING_CANCELLED', 'PAYMENT_RECEIVED', 'PAYMENT_RELEASED', 'MESSAGE_NEW', 'REVIEW_NEW', 'WITHDRAWAL_APPROVED', 'WITHDRAWAL_REJECTED', 'SUBSCRIPTION_EXPIRING', 'SYSTEM');
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
